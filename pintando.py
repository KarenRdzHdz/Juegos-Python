...
# Funcion para dibujar una linea desde un punto hasta otro
def line(start, end):
...
def circle(start, end):                 # ***Funcion de circulo completada***
...
def rectangle(start, end):                 # ***Funcion de rectangulo completada***
...
def triangle(start, end):                 # ***Funcion de triangulo completada***
